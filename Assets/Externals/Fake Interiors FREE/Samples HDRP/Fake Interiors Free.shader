	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				output.ase_texcoord6.xyz = vertexToFrag143_g1;
						 ...
						 )
			{
				...
				float3 vertexToFrag143_g1 = packedInput.ase_texcoord6.xyz;
				...
				float2 uv_FacadeAlbedo = UV0.xy * _FacadeAlbedo_ST.xy + _FacadeAlbedo_ST.zw;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 vertexToFrag143_g1 = inputMesh.positionOS;
				output.ase_texcoord2.xyz = vertexToFrag143_g1;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS output)
			{
				...
				float3 vertexToFrag143_g1 = inputMesh.positionOS;
				output.ase_texcoord8.xyz = vertexToFrag143_g1;
					 ...
					 )
			{
				...
				float4 temp_output_13_0_g1 = ( ( _RoomsXYZPropsW + float4( -1E-05,-1E-05,-1E-05,-1E-05 ) ) * _RoomTile );
				float3 vertexToFrag143_g1 = packedInput.ase_texcoord8.xyz;
				#ifdef _SWITCHPLANE_ON
				float staticSwitch147_g1 = (vertexToFrag143_g1).z;
				#else
				float staticSwitch147_g1 = (vertexToFrag143_g1).x;
