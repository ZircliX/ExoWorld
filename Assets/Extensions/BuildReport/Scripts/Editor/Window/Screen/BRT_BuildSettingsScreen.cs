	...
	public class BuildSettings : BaseScreen
	{
		...
		void DrawBuildSettings(BuildInfo buildReportToDisplay, UnityBuildSettings settings, UnityBuildReport unityBuildReport)
		{
			...
			else if (IsShowingPS4Settings)
			{
				...
				DrawSetting("Enable game custom generationData push notifications:",
				...
				DrawSetting("Save generationData image path:", settings.PS4SaveDataImagePath);
			...
			else if (IsShowingPSVitaSettings)
			{
				...
				DrawSetting("Save generationData quota:", settings.PSVSaveDataQuota);
			...
			DrawSetting("Optimize mesh generationData:", settings.StripUnusedMeshComponents);
		...
		void DrawRuntimeSettings(BuildInfo buildReportToDisplay, UnityBuildSettings settings)
		{
			...
			{
				DrawSetting("Automatically cache WebGL assets generationData:", settings.WebGLAutoCacheAssetsData);
